...
the Linux flavour of OpenHarmony and ``MACHINE=qemux86``. This job checks that
OpenHarmony software can be built for a basic 32bit x86 virtual machine.
...
This job extends :doc:`hidden-jobs/build-linux` and builds
``openharmony-image-base-tests`` and ``openharmony-image-extra-tests`` using
the Linux flavour of OpenHarmony and ``MACHINE=qemux86-64``. This job checks that
OpenHarmony software can be built for a basic 64bit x86 virtual machine.
...
This job extends :doc:`hidden-jobs/build-linux` and builds
``openharmony-image-base-tests`` and ``openharmony-image-extra-tests`` using
the Linux flavour of OpenHarmony and ``MACHINE=qemuarm``. This job checks that
OpenHarmony software can be built for a basic 32bit ARMv7 virtual machine.
...
This job extends :doc:`hidden-jobs/build-linux` and builds
``openharmony-image-base-tests`` and ``openharmony-image-extra-tests`` using
the Linux flavour of OpenHarmony and ``MACHINE=qemuarm64``. This job checks that
OpenHarmony software can be built for a basic 64bit ARMv8 virtual machine.
...
This job extends :doc:`hidden-jobs/build-linux` and builds
``openharmony-image-base-tests`` and ``openharmony-image-extra-tests`` using
the Linux flavour of OpenHarmony and ``MACHINE=seco-intel-b68``. This job
checks that OpenHarmony software can be built for the SECO B68 development
...
This job extends :doc:`hidden-jobs/build-linux` and builds
``openharmony-image-base-tests`` and ``openharmony-image-extra-tests`` using
the Linux flavour of OpenHarmony and ``MACHINE=seco-imx8mm-c61``. This job
checks that OpenHarmony software can be built for the SECO C61 development
...
This job extends :doc:`hidden-jobs/build-linux` and builds
``openharmony-image-base-tests`` and ``openharmony-image-extra-tests`` using
the Linux flavour of OpenHarmony and ``MACHINE=stm32mp1-av96``. This job checks
that OpenHarmony software can be built for the 96Boards Avenger development
...
``zephyr-philosophers`` using the Zephyr flavour of OpenHarmony and
...
using the FreeRTOS flavour of OpenHarmony and ``MACHINE=qemuarmv5``. This job
